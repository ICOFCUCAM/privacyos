    ...
    <section className="mx-auto max-w-6xl px-6 py-24">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-lg text-slate-400">
          PrivacyOS runs a fleet of autonomous AI agents that discover exposures, remove them,
          and defend your footprint 24/7 — you see outcomes, not complexity.
        </p>
      </div>
    ...
    <section className="border-y border-border bg-bg-subtle/30">
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-6 py-24 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-4 text-lg text-slate-400">
            The moment something changes — a new exposure, a leaked credential, a reputation hit —
            PrivacyOS detects it, prioritizes it, and acts. Continuous discovery, removal, and
            defense, running in the background so you don&apos;t have to.
          </p>
  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-24">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-lg text-slate-400">
          Not a single-purpose app — five integrated suites that protect individuals, executives,
          families, businesses and enterprises from one console.
        </p>
      </div>

      <div className="mt-12 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
        {suites.map((s) => (
          <div key={s.name} className="group rounded-xl border border-border bg-bg-elevated/60 p-5 transition hover:border-brand/40">
            <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-brand/25 to-brand/5">
              <s.icon className="h-5 w-5 text-brand-fg" />
            </span>
