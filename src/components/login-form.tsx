...
export function LoginForm({
  ...
  return (
    <div className="space-y-4">
      ...
      {oauthError && <p className="text-xs text-risk-critical">{oauthError}</p>}
      ...
      {configured && (
        <div className="space-y-2">
          <form action={signInWithGoogle}>
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-border bg-bg-subtle px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-bg-elevated"
            >
